...
class _EditPostPageState extends State<EditPostPage> {
  ...
  void initState() {
    ...
    _controller = TextEditingController(
      text: widget.post.reflectionText,
    );
  }
                      ...
                      Container(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            counterStyle: GoogleFonts.spectral(
                              fontSize: 10,
          ...
          SizedBox(
            ...
            child: Stack(
              children: List.generate(
                ...
                (i) {
                  final assetPath =
                      post.cardData[i]['assetPath'] as String? ??
                          kTarotDeck[
                                  post.cardData[i]['cardIndex'] as int]
                              .assetPath;
